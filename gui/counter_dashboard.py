...
class CounterDashboardWindow(QMainWindow):
    def __init__(self, job_id, user_name="USER"):
        ...
        self.asset1_spinbox.setRange(0, 999)
        ...
        self.asset2_spinbox.setRange(0, 999)
        ...
        self.asset3_spinbox.setRange(0, 999)
        ...
        self.asset4_spinbox.setRange(0, 999)
        ...
        self.asset5_spinbox.setRange(0, 999)
        ...
        self.asset6_spinbox.setRange(0, 999)
